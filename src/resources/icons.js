...
export { LOGO_FINGOPAY } from './icons/logo_fingopay.js'
export { LOGO_GOOGLE_HANGOUTS } from './icons/logo_google_hangouts.js'
export { LOGO_INSTAGRAM } from './icons/logo_instagram.js'
export { LOGO_LEANJS } from './icons/logo_leanjs.js'
export { LOGO_LINKEDIN } from './icons/logo_linkedin.js'
export { LOGO_TWITTER } from './icons/logo_twitter.js'
