    ...
    content: (
      <React.Fragment>
        ...
        <P>
          ...
          unsubscribe, please email us as <MailtoLink to="hello@leanjs.com" />.
        </P>
      </React.Fragment>
    ),
  },
    ...
    content: (
      <React.Fragment>
        ...
        <P>
          ...
          parent company, LeanJS may share your name, email, and/or phone number
          with our sub-brands. As part of the LeanJS brand, these sub-brands
          will follow our over-arching privacy guidelines regarding sharing
        ...
        <P>
          ...
          what you share with us will inevitably be stored on their property.
          Please find Amazon Web Services' Privacy Policy{' '}
          <Link to="https://aws.amazon.com/privacy/">here</Link>.
        </P>
      </React.Fragment>
    ),
  },
...
const PrivacyPolicyPage = () => (
  <div>
    <Header
      ...
      intro="Here at LeanJS, we are committed to taking your privacy seriously and always aim to make sure that your personal information is kept safe. We aim to instill trust in everything that we do and give you the best quality experience with us."
    />
    <Section padded>
